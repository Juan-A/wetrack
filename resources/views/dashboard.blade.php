...
<!--grid-cols-2 gap-4-->
                    <div class="stats shadow mt-3  stats-vertical md:stats-horizontal">
                        <div class="stat">
                            ...
                            <div class="stat-title">Número de reviews</div>
                        ...
                        <div class="stat">
                            ...
                            <div class="stat-title">¿Sueles ser generoso?</div>
                            <div class="stat-value">{{ $userAvg }}</div>
                    ...
                    <a href={{ url('/profile') }} class="btn w-fit self-center mt-4">
                        Editar tu perfil o eliminar la cuenta
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
