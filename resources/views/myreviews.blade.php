                            ...
                            @foreach ($reviews as $review)
                                ...
                                <a href="{{ route('track.show', $review->track->json['id']) }}" class="">
                                    <div class="p-2 m-3 dark:bg-slate-700 rounded-lg flex items-center">
                                        ...
                                        <label for="delete_{{$review->id}}" class="btn btn-circle btn-outline btn-sm mr-4 ml-4">
                                        ...
                                        <input type="checkbox" id="delete_{{$review->id}}" class="modal-toggle" />
                                        ...
                                        <div class="modal-box">
                                            <form action="{{ route('review.delete', $review) }}" method="POST"
                                                ...
                                                <div class="mt-6 flex justify-end">
                                                    <label for="delete_{{$review->id}}" class="btn">CANCELAR</label>
