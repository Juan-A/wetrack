...
<body class="font-sans antialiased  dark:text-slate-700 h-dvh">
    <div
        ...
        <div class="flex justify-around flex-wrap">
            ...
            <div id="topCommented"
                class=" mt-5 pt-5 pb-5 mb-10 self-center bg-opacity-25 bg-slate-200 rounded-xl flex flex-col flex-wrap w-11/12 lg:w-2/5">
                <div class="flex ml-9">
                ...
                <div class="flex justify-around flex-wrap w-11/12 lg:w-11/12 self-center">
                    ...
                    @foreach ($topCommented as $reviewed)
                        <div class="flex flex-col w-2/5 md:max-w-40 lg:max-w-44 mr-1">
                            <div class="flex justify-center mt-3"><img src={{ $reviewed->track->json['album']['images'][1]['url'] }}
                                    class="w-full rounded-lg"></div>
                            <span class="font-bold text-lg">{{ $reviewed->track->name }}</span>
                            <span>
                                Con una nota de {{ $reviewed->calification }}
                            </span>
